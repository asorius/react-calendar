...
export default function About() {
  ...
  const description =
    'Blue bottle crucifix vinyl post-ironic four dollar toast vegantaxidermy. Gastropub indxgo juice poutine, ramps microdosing banh mi pug.';
  const features = Array.from(new Array(7), (element, i) => ({
  ...
  return (
    <section
      ...
      <div className='container px-5 py-24 mx-auto'>
        ...
        <div className='flex flex-wrap relative pt-6'>
          <svg
            width='267'
            height='37'
            viewBox='0 0 267 37'
            className='fill-accent/50 absolute -top-12 left-0 mx-auto'
