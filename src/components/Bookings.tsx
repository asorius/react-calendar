...
export default function Bookings({ children }: { children: React.ReactNode }) {
  return (
    <section
      id='Bookings'
      className=' px-8 py-24 mx-auto bg-bookings-background bg-no-repeat bg-cover bg-center bg-fixed h-full w-full min-h-screen'>
      <div className='container mx-auto'>
        <div className='slogan '>
          <h1 className={headerClasses + ' lg:hidden'}>Book Yours</h1>
          <h1 className={headerClasses + ' hidden lg:block'}>Book</h1>
          <h1 className={headerClasses + ' hidden lg:block'}>Yours</h1>
          <div className='text-center py-6  px-2 relative rounded-lg  bg-white shadow-lg shadow-gray-light mt-10'>
            {bookingDetails}
            <svg
              width='130'
              height='130'
              viewBox='0 0 130 130'
              className='arrow absolute top-36 left-[50%] rotate-90 h-24 fill-accent z-30'
