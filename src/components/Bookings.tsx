...
export default function Bookings({ children }: { children: React.ReactNode }) {
  return (
    <section
      id='Bookings'
      className=' px-8 py-24 mx-auto bg-gradient-to-tl from-main/60 to-accent/20 min-h-screen'>
      <div className='container mx-auto'>
        <div className='slogan '>
          ...
          <div className='text-center py-6  relative rounded-lg  bg-gray-light/20 mt-10'>
            {bookingDetails}
            <svg
              width='130'
              height='130'
              viewBox='0 0 130 130'
              className='arrow absolute top-40 left-[50%] rotate-90 h-24 fill-accent z-10'
